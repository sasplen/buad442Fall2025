...
- **Right-click** in your new nickname folder → "Paste"
- **Double-click** the copied `submission.md` (i.e. the one in your student folder) to open and edit it
- Edit `submission.md` with your info and two cool pictures of you and/or your interests (these are public images)
...
##  Quick Git Basics
- **Commit** = Save your changes so you can go back to these files at this instant in time - do often as AI will gladly mess up your files and give you an unrecoverable mess on your hands
- **Push** = Upload to GitHub
- **Pull Request** = Request to add your changes to original repo
- **Fork** = Your copy of the originalrepo
